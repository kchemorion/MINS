...
int qSlicerCoreApplicationTest1(int, char*[]);
int qSlicerCoreIOManagerTest1(int, char*[]);
int qSlicerLoadableModuleFactoryTest1(int, char*[]);
int qSlicerUtilsTest1(int, char*[]);
int qSlicerCorePythonManagerWithoutApplicationTest(int, char*[]);
int qSlicerScriptedUtilsTest1(int, char*[]);
int qSlicerSslTest(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "qSlicerLoadableModuleFactoryTest1",
    qSlicerLoadableModuleFactoryTest1
  },
  {
    "qSlicerUtilsTest1",
  ...
  {
    "qSlicerCorePythonManagerWithoutApplicationTest",
    qSlicerCorePythonManagerWithoutApplicationTest
  },
  {
    "qSlicerScriptedUtilsTest1",
    qSlicerScriptedUtilsTest1
  },
  {
    "qSlicerSslTest",
