...
int qSlicerApplicationTest1(int, char*[]);
int qSlicerDataDialogTest1(int, char*[]);
int qSlicerDirectoryListViewTest1(int, char*[]);
int qSlicerLayoutManagerTest1(int, char*[]);
int qSlicerModulePanelTest1(int, char*[]);
int qSlicerMouseModeToolBarTest1(int, char*[]);
int qSlicerSaveDataDialogCustomFileWriterTest(int, char*[]);
int qSlicerWidgetTest1(int, char*[]);
int qSlicerWidgetTest2(int, char*[]);
int qSlicerLoadableModuleWithPythonTest(int, char*[]);
int qSlicerPythonManagerWithoutApplicationTest(int, char*[]);
int qSlicerScriptedLoadableModuleTest(int, char*[]);
int qSlicerScriptedLoadableModuleWidgetTest(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "qSlicerAbstractModuleTest1",
    qSlicerAbstractModuleTest1
  },
  {
    "qSlicerAbstractModuleWidgetTest1",
    qSlicerAbstractModuleWidgetTest1
  },
  {
    "qSlicerApplicationTest1",
    qSlicerApplicationTest1
  },
  {
    "qSlicerDataDialogTest1",
    qSlicerDataDialogTest1
  },
  {
    "qSlicerDirectoryListViewTest1",
    qSlicerDirectoryListViewTest1
  },
  {
    "qSlicerLayoutManagerTest1",
    qSlicerLayoutManagerTest1
  },
  {
    "qSlicerModulePanelTest1",
    qSlicerModulePanelTest1
  },
  {
    "qSlicerMouseModeToolBarTest1",
    qSlicerMouseModeToolBarTest1
  },
  {
    "qSlicerSaveDataDialogCustomFileWriterTest",
    qSlicerSaveDataDialogCustomFileWriterTest
  },
  {
    "qSlicerWidgetTest1",
  ...
  {
    "qSlicerLoadableModuleWithPythonTest",
    qSlicerLoadableModuleWithPythonTest
  },
  {
    "qSlicerPythonManagerWithoutApplicationTest",
    qSlicerPythonManagerWithoutApplicationTest
  },
  {
