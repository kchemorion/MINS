...
int vtkSegmentationTest1(int, char*[]);
int vtkSegmentationTest2(int, char*[]);
int vtkSegmentationHistoryTest1(int, char*[]);
int vtkSegmentationConverterTest1(int, char*[]);
int vtkClosedSurfaceToFractionalLabelMapConversionTest1(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "vtkSegmentationTest1",
    vtkSegmentationTest1
  },
  {
    "vtkSegmentationTest2",
    vtkSegmentationTest2
  },
  {
    "vtkSegmentationHistoryTest1",
    vtkSegmentationHistoryTest1
  },
  {
    "vtkSegmentationConverterTest1",
    vtkSegmentationConverterTest1
  },
  {
    "vtkClosedSurfaceToFractionalLabelMapConversionTest1",
    vtkClosedSurfaceToFractionalLabelMapConversionTest1
  },
