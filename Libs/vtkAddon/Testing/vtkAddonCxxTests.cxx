...
int vtkAddonMathUtilitiesTest1(int, char*[]);
int vtkAddonTestingUtilitiesTest1(int, char*[]);
int vtkLoggingMacrosTest1(int, char*[]);
int vtkParallelTransportTest1(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "vtkAddonMathUtilitiesTest1",
    vtkAddonMathUtilitiesTest1
  },
  {
    "vtkAddonTestingUtilitiesTest1",
    vtkAddonTestingUtilitiesTest1
  },
  {
    "vtkLoggingMacrosTest1",
    vtkLoggingMacrosTest1
  },
  {
    "vtkParallelTransportTest1",
    vtkParallelTransportTest1
  },
  {
    "vtkPersonInformationTest1",
    vtkPersonInformationTest1
  },
