...
int vtkMRMLCameraDisplayableManagerTest1(int, char*[]);
int vtkMRMLCameraWidgetTest1(int, char*[]);
int vtkMRMLModelDisplayableManagerTest(int, char*[]);
int vtkMRMLModelSliceDisplayableManagerTest(int, char*[]);
int vtkMRMLThreeDReformatDisplayableManagerTest1(int, char*[]);
int vtkMRMLThreeDViewDisplayableManagerFactoryTest1(int, char*[]);
int vtkMRMLDisplayableManagerFactoriesTest1(int, char*[]);
int vtkMRMLSliceViewDisplayableManagerFactoryTest(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "vtkMRMLCameraWidgetTest1",
    vtkMRMLCameraWidgetTest1
  },
  {
    "vtkMRMLModelDisplayableManagerTest",
    vtkMRMLModelDisplayableManagerTest
  },
  {
  ...
  {
    "vtkMRMLThreeDViewDisplayableManagerFactoryTest1",
    vtkMRMLThreeDViewDisplayableManagerFactoryTest1
  },
  {
    "vtkMRMLDisplayableManagerFactoriesTest1",
    vtkMRMLDisplayableManagerFactoriesTest1
  },
  {
    "vtkMRMLSliceViewDisplayableManagerFactoryTest",
    vtkMRMLSliceViewDisplayableManagerFactoryTest
  },
