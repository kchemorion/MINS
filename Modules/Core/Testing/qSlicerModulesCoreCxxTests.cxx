...
int qSlicerEventBrokerModuleGenericTest(int, char*[]);
int qSlicerEventBrokerModuleWidgetGenericTest(int, char*[]);
int qSlicerCoreModuleTest1(int, char*[]);
int qSlicerCoreModuleFactoryTest1(int, char*[]);
int qSlicerModulePanelTest2(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "qSlicerEventBrokerModuleGenericTest",
    qSlicerEventBrokerModuleGenericTest
  },
  {
    "qSlicerEventBrokerModuleWidgetGenericTest",
    qSlicerEventBrokerModuleWidgetGenericTest
  },
  {
    "qSlicerCoreModuleTest1",
    qSlicerCoreModuleTest1
  },
  {
    "qSlicerCoreModuleFactoryTest1",
    qSlicerCoreModuleFactoryTest1
  },
  {
    "qSlicerModulePanelTest2",
    qSlicerModulePanelTest2
  },
