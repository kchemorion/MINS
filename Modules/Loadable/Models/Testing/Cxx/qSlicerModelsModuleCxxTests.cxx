...
int qSlicerModelsModuleWidgetTest(int, char*[]);
int qSlicerModelsModuleWidgetTest1(int, char*[]);
int qSlicerModelsModuleWidgetTestScene(int, char*[]);
int vtkSlicerModelsLogicAddFileTest(int, char*[]);
