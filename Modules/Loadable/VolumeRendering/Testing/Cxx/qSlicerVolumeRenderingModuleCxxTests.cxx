...
int qMRMLVolumePropertyNodeWidgetTest1(int, char*[]);
int qSlicerPresetComboBoxTest(int, char*[]);
int qSlicerVolumeRenderingModuleWidgetTest1(int, char*[]);
int qSlicerVolumeRenderingModuleWidgetTest2(int, char*[]);
int vtkMRMLShaderPropertyStorageNodeTest1(int, char*[]);
int vtkMRMLVolumePropertyNodeTest1(int, char*[]);
int vtkMRMLVolumePropertyStorageNodeTest1(int, char*[]);
int vtkMRMLVolumeRenderingDisplayableManagerTest1(int, char*[]);
int vtkMRMLVolumeRenderingMultiVolumeTest(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "qMRMLVolumePropertyNodeWidgetTest1",
    qMRMLVolumePropertyNodeWidgetTest1
  },
  {
    "qSlicerPresetComboBoxTest",
    qSlicerPresetComboBoxTest
  },
  {
    "qSlicerVolumeRenderingModuleWidgetTest1",
    qSlicerVolumeRenderingModuleWidgetTest1
  },
  {
    "qSlicerVolumeRenderingModuleWidgetTest2",
    qSlicerVolumeRenderingModuleWidgetTest2
  },
  {
    "vtkMRMLShaderPropertyStorageNodeTest1",
    vtkMRMLShaderPropertyStorageNodeTest1
  },
  {
  ...
  {
    "vtkMRMLVolumePropertyStorageNodeTest1",
    vtkMRMLVolumePropertyStorageNodeTest1
  },
  {
  ...
  {
    "vtkMRMLVolumeRenderingMultiVolumeTest",
    vtkMRMLVolumeRenderingMultiVolumeTest
  },
